...
import com.customlife.app.fragment.H5Fragment;
...
public class MemberRightActivity extends BaseActivity {
    ...
    protected void initViews(Bundle savedInstanceState) {
        new ActionbarBuilder(this).setTitleText("会员权益")
        ...
        title = getResources().getStringArray(R.array.member);
